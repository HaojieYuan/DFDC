...
class faceforensicsDataset(Dataset):
    ...
    def __init__(self, rootpath, datapath, transform=None):
        ...
        for line in imgsfolderPath:
            line = line.rstrip()
            words = line.split()
            filelist = glob.glob(os.path.join(rootpath, words[0], '*.jpg'))
            #print(len(filelist))
...
if __name__ == "__main__":
    face_dataset = faceforensicsDataset(rootpath='/home/mct/faceforensics++/', datapath='/home/mct/faceforensics++/train.txt')
